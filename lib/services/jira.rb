...
protected
  ...
  def assignee_fields(resource, issue_type)
    if (issue_type.has_field_assignee.nil? || issue_type.has_field_assignee) && resource.assigned_to_user && (user = user_resource.picker(resource.assigned_to_user.email))
